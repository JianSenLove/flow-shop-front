	...
	<view>
		...
		<view class="goods-section">
			...
			<view class="g-item" v-for="(itme,index) in List" :key="index">
				...
				<view class="right">
					<text class="title clamp">{{itme.name}}</text>
					<text class="spec">{{itme.desc}}</text>
					<view class="price-box">
						<text class="price">￥{{itme.price}}</text>
						<text class="number">x {{itme.num}}</text>
					</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		onLoad(option) {
			...
			this.List = JSON.parse(orderData);
			this.calculateTotal();
		},
		onShow() {
			this.address();
