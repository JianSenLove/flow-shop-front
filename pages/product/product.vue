	...
	<view class="container">
		<view class="carousel">
			<view class="image-wrapper">
				<image :src="detail.image" class="loaded" mode="aspectFill"></image>
			</view>
		</view>
		...
		<view class="introduce-section">
			...
			<view>
				<text class="ftitle">{{detail.desc}}</text>
			</view>
		...
		<view class="page-bottom">
			<navigator url="/pages/product/list" open-type="switchTab" class="p-b-btn">
